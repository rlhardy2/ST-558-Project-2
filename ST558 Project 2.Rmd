...
The second function is a function that will return a list of breweries of user-specified length and state. Default length is 20 and default state is North Carolina (note: states should be lowercase and have an underscore if they are two or more words).
