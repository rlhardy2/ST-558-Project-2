...
From the tibble above we can see that 45 percentage of all the brewery in Wisconsin are either a brewpub or a bar and in North Dakota 20 percentage of all the brewery in Wisconsin are either a brewpub or a bar which could be a possibly explanation for the high consumption of alcohol in those states. 
