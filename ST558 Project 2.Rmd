...
Next we create some numerical summaries for the mean of the longitude and latitude of our two states of interest Wisconsin and North Dakota. It should be notes that the combine_tibble object is already group_by(state) and we remove the Na values.
